...
view = Backbone.View.extend({
    ...
    calculate: function(){
        ...
        */
        ...
        this.$('#result h1').append("<br>Cумма веса барабанов и веса намотанного на него кабеля: " + ((result_barabans * this.filtered_barabans.ves_barabana) + (result_barabans * vesKabelya)) );
    },
    submit: function(e){
        e.preventDefault();
        this.calculate();
