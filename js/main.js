    ...
    calculate: function(){
        ...
        */
        ...
        var cable_mark = this.$('select[name=cable_mark] option:selected').index()==0 ? this.$('select[name=cable_mark] option:eq(1)').html() : this.$('select[name=cable_mark] option:selected').html() ;
            ...
            result_text += "<ul><li><b>" + result_barabans + "</b> барабанов</li><li> общий объем <b>" + (result_barabans * this.filtered_barabans.obem_barabana) + "м³</b></li><li>общий вес <b>" + (lenght_kabelya * (vesKabelya / 1000)) + "</b>кг</li></ul>";
